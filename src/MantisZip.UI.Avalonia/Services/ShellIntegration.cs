...
internal static partial class ShellIntegration
{
    ...
    private static readonly string OpenDisplay = LocalizationManager.T("Shell_Open");
    private static readonly string ExtractHereDisplay = LocalizationManager.T("Shell_ExtractHere");
    private static readonly string ExtractSmartDisplay = LocalizationManager.T("Shell_SmartExtract");
    private static readonly string ExtractToNamedDisplay = LocalizationManager.T("Shell_ExtractToNamed");
    private static readonly string ExtractDisplay = LocalizationManager.T("Shell_ExtractTo");
    private static readonly string CompressSeparateDisplay = LocalizationManager.T("Shell_CompressSeparate");
    private static readonly string CompressCombinedDisplay = LocalizationManager.T("Shell_CompressCombined");
    private static readonly string CompressDisplay = LocalizationManager.T("Shell_Compress");
    ...
    {
        // 可执行文件所在目录（兼容 dotnet run 场景）
        var assemblyPath = Environment.ProcessPath ?? Assembly.GetExecutingAssembly().Location;
        var dir = Path.GetDirectoryName(assemblyPath);
        if (dir != null)
        {
            var exePath = Path.Combine(dir, "MantisZip.UI.Avalonia.exe");
